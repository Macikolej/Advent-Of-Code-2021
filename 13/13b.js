...
for (let i = (indexOfLastCoordinate + 1); i < arrayOfLines.length; i ++) { // + 1 to avoid blank space
  if (arrayOfLines[i].split("fold along")[1] !== undefined) {
    let splitCoordinate = arrayOfLines[i].split("fold along")[1].split("");
